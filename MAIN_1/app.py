...
def save_box_pair():
    ...
    try:
        ...
        # Save coordinates as integers in the database
        c.execute(f"""
...
def check_gaze_in_aoi(x, y):
    global matched_boxes, current_user  # Use the global list to store matched boxes across calls
    ...
    try:
        ...
        # Check if the user has changed; no need to clear twice
        ...
        offsets = {
            "code": {"left": 0, "top": 0},
            "graph": {"left": 960, "top": 0},  # Example offset for graph section
        }
        ...
        # Fetch all table names to verify table existence
